...
function formPrestamos() {
    ...
    let desaprobado = sessionStorage.getItem(`formPrestamos`) != `1` && `<h2>Lo sentimos, pero no cumples con los requisitos mínimos para aplicar a este préstamo. :'(</h2>`
    document.getElementById(`prestamo`).innerHTML = (aprobado || desaprobado)
}
